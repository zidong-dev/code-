...
%Hp
    Hp0=0.05;
    thetax=45*3.14/180;
    Hp(i+1,3)=Hp0*sin(w*t(i+1,1));
    Hp(i+1,2)=Hp0*cos(w*t(i+1,1))*cos(thetax);
    Hp(i+1,1)=Hp0*cos(w*t(i+1,1))*sin(thetax);
%Heff
...
Isztot(fn,1)=sum(Iselectz(:,1))/5;
Isztot(fn,2)=sum(Iselectz(:,2))/5;
Isztot(fn,3)=sum(Iselectz(:,3))/5;
Isztot(fn,4)=sum(Iselectz(:,4))/5;
Isztot(fn,5)=sum(Iselectz(:,5))/5;
...
Isxtot(fn,1)=sum(Iselectx(:,1))/5;
Isxtot(fn,2)=sum(Iselectx(:,2))/5;
Isxtot(fn,3)=sum(Iselectx(:,3))/5;
Isxtot(fn,4)=sum(Iselectx(:,4))/5;
Isxtot(fn,5)=sum(Iselectx(:,5))/5;
...
Isytot(fn,1)=sum(Iselecty(:,1))/5;
Isytot(fn,2)=sum(Iselecty(:,2))/5;
Isytot(fn,3)=sum(Iselecty(:,3))/5;
Isytot(fn,4)=sum(Iselecty(:,4))/5;
Isytot(fn,5)=sum(Iselecty(:,5))/5;
faid=fai*5;
